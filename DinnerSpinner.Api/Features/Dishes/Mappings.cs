...
{
    public static Contract ToContract(this Dish dish, string categoryName) =>
        new()
        {
            Id = dish.Id,
    ...
    public static Create.Response ToCreateResponse(this Dish dish, string categoryName) =>
        new()
        {
            Dish = dish.ToContract(categoryName)
        };

    public static Update.Response ToUpdateResponse(this Dish dish, string categoryName)
        {
            // 1. Build contract
